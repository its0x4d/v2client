...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[common_dot_net_dot_address__pb2.DESCRIPTOR,common_dot_net_dot_port__pb2.DESCRIPTOR,transport_dot_internet_dot_config__pb2.DESCRIPTOR,google_dot_protobuf_dot_any__pb2.DESCRIPTOR,])

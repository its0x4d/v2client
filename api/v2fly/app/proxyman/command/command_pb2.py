...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[common_dot_protocol_dot_user__pb2.DESCRIPTOR,google_dot_protobuf_dot_any__pb2.DESCRIPTOR,common_dot_protoext_dot_extensions__pb2.DESCRIPTOR,config__pb2.DESCRIPTOR,])
...
_ALTERINBOUNDREQUEST.fields_by_name['operation'].message_type = google_dot_protobuf_dot_any__pb2._ANY
_ADDOUTBOUNDREQUEST.fields_by_name['outbound'].message_type = config__pb2._OUTBOUNDHANDLERCONFIG
_ALTEROUTBOUNDREQUEST.fields_by_name['operation'].message_type = google_dot_protobuf_dot_any__pb2._ANY

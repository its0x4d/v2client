...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[common_dot_net_dot_address__pb2.DESCRIPTOR,common_dot_net_dot_network__pb2.DESCRIPTOR,common_dot_protoext_dot_extensions__pb2.DESCRIPTOR,])
...
_SIMPLIFIEDCONFIG = _descriptor.Descriptor(
  ...
  full_name='v2ray.core.proxy.dokodemo.SimplifiedConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='v2ray.core.proxy.dokodemo.SimplifiedConfig.address', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='port', full_name='v2ray.core.proxy.dokodemo.SimplifiedConfig.port', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='networks', full_name='v2ray.core.proxy.dokodemo.SimplifiedConfig.networks', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='follow_redirect', full_name='v2ray.core.proxy.dokodemo.SimplifiedConfig.follow_redirect', index=3,
...
_SIMPLIFIEDCONFIG.fields_by_name['networks'].message_type = common_dot_net_dot_network__pb2._NETWORKLIST
...
SimplifiedConfig = _reflection.GeneratedProtocolMessageType('SimplifiedConfig', (_message.Message,), {
  ...
  '__module__' : 'proxy.dokodemo.config_pb2'
  # @@protoc_insertion_point(class_scope:v2ray.core.proxy.dokodemo.SimplifiedConfig)
  })

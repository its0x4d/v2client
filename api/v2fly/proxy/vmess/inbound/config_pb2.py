...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[common_dot_protocol_dot_user__pb2.DESCRIPTOR,common_dot_protoext_dot_extensions__pb2.DESCRIPTOR,])
...
_SIMPLIFIEDCONFIG = _descriptor.Descriptor(
  ...
  full_name='v2ray.core.proxy.vmess.inbound.SimplifiedConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='users', full_name='v2ray.core.proxy.vmess.inbound.SimplifiedConfig.users', index=0,
...
SimplifiedConfig = _reflection.GeneratedProtocolMessageType('SimplifiedConfig', (_message.Message,), {
  ...
  '__module__' : 'proxy.vmess.inbound.config_pb2'
  # @@protoc_insertion_point(class_scope:v2ray.core.proxy.vmess.inbound.SimplifiedConfig)
  })
